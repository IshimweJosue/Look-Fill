 ...
 * @author ishimwe
 */
public class TwoListForms extends javax.swing.JFrame {

    /**
     * Creates new form TwoListForms
     */
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TwoListForms.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TwoListForms().setVisible(true);
            }
        });
    }
